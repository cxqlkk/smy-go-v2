...
var GetProviderName = func(ctx iris.Context) (string, error) {
	...
	//fmt.Println("96",ctx.URLParam("provider"),ctx.Params().Get("provider"),ctx.Values().GetString("provider"))
...
func main() {
	goth.UseProviders(
		...
		github.New("b39984bff9ffb3b10aeb", "a6358cc36bb49650a9a29a09a71d0dab20a3e98c", "http://localhost:3000/auth/github/callback"),
